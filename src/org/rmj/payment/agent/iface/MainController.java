...
public class MainController implements Initializable {
    ...
    private double pnAdvPaymx = 0.00;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cmdAdvancePay.setOnAction(this::cmdButton_Click);
        ...
        txtOtherAmt.focusedProperty().addListener(txtField_Focus);
        ...
        txtOtherAmt.setOnKeyPressed(this::txtField_KeyPressed);
        ...
        pnCashAmtx = (pnVATSales + pnVATAmntx) - (pnCredtCrd + pnCheckPay + pnGiftCert + pnAdvPaymx);
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        switch (lsButton.toLowerCase()){
            case "cmdsave":
                ...
                if ((pnCashAmtx + pnCredtCrd + pnCheckPay + pnGiftCert + pnAdvPaymx) < Math.round(pnVATSales + pnVATAmntx)){
                ...
                if (psORNumber.equals("")){
                    ShowMessageFX.Warning("OR number not detected.", pxeModuleName, "Please verify your entry.");
                    txtReferNox.requestFocus(); 
                    return;
                } 
                
                //compute how much will be deducted from cash tendered base on the other payments issued.
                double lnAmtPaid = pnCredtCrd + pnCheckPay + pnGiftCert;
    ...
    private void computePay(){        
        ...
        //txtCashAmtx.setText(CommonUtils.NumberFormat(pnCashAmtx, "###0.00"));
        txtOtherAmt.setText(CommonUtils.NumberFormat(pnCredtCrd + pnCheckPay + pnGiftCert + pnAdvPaymx, "###0.00"));
        ...
        lblAdvance.setText(CommonUtils.NumberFormat(pnAdvPaymx, "###0.00"));
        
        lblAmountPaid.setText(CommonUtils.NumberFormat(pnCashAmtx +  pnCredtCrd + pnCheckPay + pnGiftCert + pnAdvPaymx, "###0.00"));
        lblChange.setText(CommonUtils.NumberFormat((pnCashAmtx +  pnCredtCrd + pnCheckPay + pnGiftCert + pnAdvPaymx) - (pnVATSales + pnVATAmntx), "###0.00"));
    }
    ...
    private void showAdvancePayment(){
